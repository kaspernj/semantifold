...
- [036 — Language compatibility stdlib/facades](036-language-compatibility-stdlib-facades.md) — implemented on topic branch; review / CI / merge remain
- [037 — Blocking TCP client stdlib vertical slice](037-blocking-tcp-client-stdlib-vertical-slice.md)

Phase S implements the [standard-library portability design](../docs/standard-library-portability.md) in dependency order. Tasks 032–035 are delivered, including the Task 035 versioned canonical contract/provider hub. Task 036 implements bounded neutral original-five facades after Task 035; Task 037 remains the separate Ruby `TCPSocket` to PHP provider proof. No Phase S task claims complete or all-language stdlib support. See the [implementation plan](../docs/plans/2026-09-05-standard-library-portability.md).
...
| [036](036-language-compatibility-stdlib-facades.md) | implemented on topic branch (S) | P1 | Versioned executable source-language qualification facades; review / CI / merge remain | 035 |

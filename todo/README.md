...
Tasks 001–025 and 028–038 are delivered in released `semantifold@0.9.0`; their exact PR, commit, CI, and acceptance history remains in the task records and [SOURCES.md](SOURCES.md). Task 039's strict manifest and one-shot build CLI shipped through PR #56 at merge commit `41770a2734152640badbb28da50f10dede01aa40`; Task 040's generic check-plan contract and Java/`javac` slice shipped through PR #57 at merge commit `6af0c371a2d904ba502df915cbd42e9aacd82904`; Task 043's deterministic watch coordinator shipped through PR #58 at merge commit `40dcc86372929fb4747da08cd8e9d8226a32d88d`; Task 044's packed JavaScript/JSDoc-to-Java watch slice shipped through PR #59 at merge commit `d5d956c69b3039a17a3b53034d6847207d293faf`; and Task 041's interpreted/managed checks shipped through PR #60 at merge commit `73a1317d8eaeab3d882dbd170305683c33b23e51`. Task 042's native/project check plans are implemented on their feature branch with focused and static/package validation complete; review, TensorBuzz CI, merge, and release remain pending. Task 026 has deterministic generation/provenance while Apple materialization and acceptance remain deferred. Task 027 remains deferred roadmap work. Tasks 045–046 remain planned check/watch work and grant no implementation authority by themselves.
...
### Delivered C expansion — Task 018
...
Swift is in this cohort because it is a modern general-purpose language independently of iOS. Kotlin/JVM adds a major JVM language without making Android tooling part of the gate. Go adds a distinct garbage-collected native/package/toolchain model. Dart adds a strict Task-005 VM/native package lane without claiming Flutter or browser Dart. Zig adds its separate strict Task-005 native-project lane without changing the historical Task-025 cohort.
...
- [008 — Ordered list iteration](008-collection-iteration.md) — delivered in PR 31 at `275711332157bbe8d2af6f4189e7849f344bf31f`
- [013 — Five-language compatibility acceptance](013-five-language-compatibility-acceptance.md) — delivered through PRs 32/33 at `a78e513aa9929d8baaf1761079d5f486575bc8f0`
...
- [032 — Condition-controlled loops and break/continue](032-condition-controlled-loops-and-break.md) — delivered through PR #42 at `8ad60e381f14ab5dab85d6d1996e58de7e3f84bc`, merged as `e6889212a57d4d0820b9c5cd3ad21b0ef8cc2c9e`
- [033 — Reference classes, methods, and constructors](033-reference-classes-methods-and-constructors.md) — delivered through PR #43 at exact head `98a9fa5bb1048fbe44e798acdefd65b9d6d2560e`, merged as `f2e7f44aa8065f785c314b66e1f1d55992b7c998`
- [034 — Effectful capabilities and resource lifetime](034-effectful-capabilities-and-resource-lifetime.md) — delivered through PR #44, merged as `c15e0874c054b6c462304eb29538d72ed43829d6`
- [035 — Versioned standard-library contracts and provider linking](035-versioned-standard-library-contracts-and-provider-linking.md) — delivered through PR #45, merged as `a2aad9d4932bfc6087adc4ff8bca43678c92413c`
- [036 — Language compatibility stdlib/facades](036-language-compatibility-stdlib-facades.md) — delivered through PR #46, merged as `9aba48f9d48bcef4fd4c9275aec14bfcc4f0904c`
- [037 — Blocking TCP client stdlib vertical slice](037-blocking-tcp-client-stdlib-vertical-slice.md) — delivered through PRs #47/#48

Phase S implements the [standard-library portability design](../docs/standard-library-portability.md) in dependency order. Tasks 032–036 are delivered, including the canonical contract/provider hub and neutral original-five facade foundation. Task 037 delivered the separate Ruby `TCPSocket` and bounded `puts` to protected PHP provider proof through PRs #47/#48. No Phase S task claims complete or all-language stdlib support. See the [implementation plan](../docs/plans/2026-09-05-standard-library-portability.md).
...
- [030 — Dart/Flutter application artifact target](030-flutter-application-target.md) — delivered through merged PR #53 and `v0.7.0`; iOS/macOS proof deferred
...
- [043 — Deterministic watch coordinator](043-deterministic-watch-coordinator.md) — delivered through PR #58 at merge commit `40dcc86372929fb4747da08cd8e9d8226a32d88d`
- [044 — JavaScript/JSDoc-to-Java watch vertical slice](044-jsdoc-java-watch-vertical-slice.md) — implementation complete in PR #59; local focused/static/package validation passed; review/CI/merge pending
...
Phase W follows the [watch/build/check design](../docs/watch-build-pipeline.md). Tasks 038–040 and 043–044 now supply transactional persistent publication, the strict one-shot project CLI, Java's target-owned non-executing `javac` plan, deterministic serialized watch orchestration, and the first packed JavaScript/JSDoc-to-Java checked watch slice. Ordinary operation still generates only; `--check` compiles Java without running it. Tasks 041–042 and 045 remain the check/watch delivery chain in dependency order, with Task 045 as its single terminal acceptance task. Task 046 later defines truthful watch/check policies for Wasm and application targets without reopening deferred Apple/Xcode work.
...
| Apple/iOS | Ruby and any registered project frontend | implemented deterministic generation/provenance; materialization and Apple acceptance deferred | deterministic unsigned Swift/Xcode project model | Swift 6.3.3 Linux proof; filesystem publication and Xcode/iOS Simulator deferred | Task 010 project to UI shell |
...
| Reference classes | Tasks 005 and 009 then Task 033 | adopted by the original five only | inheritance, reflection, open classes, or facade/provider behavior |
| Effectful capabilities/resources | Tasks 005, 007, 011, and 033 then Task 034 | adopted by the original five only | general effects, implicit cleanup, public host APIs, or provider linking |
...
015 ── 038 transactional publication ── 039 project build CLI (also 010)
                                            └── 040 target check contract + Java
                                                ├── 041 managed/interpreted plans ─┐
                                                ├── 042 native/project plans ──────┤
                                                └── 043 watcher ── 044 JS/JSDoc→Java slice
                                                                                  └── 045 terminal text matrix
                                                                                       └── 046 later non-text policies
```
...
| [030](030-flutter-application-target.md) | delivered (P; PR #53, `v0.7.0`; Apple proof deferred) | P2 | Flutter application artifacts | 010, 028, 029 |
...
| [041](041-interpreted-managed-target-check-plans.md) | delivered (W; PR #60) | P1 | PHP/Ruby/JS/TS/Kotlin/Python/C# checks | 040 |
| [042](042-native-project-target-check-plans.md) | implementation complete (W; review/CI/merge pending) | P1 | Go/C/C++/Rust/Swift/Dart/Zig checks | 040 |
| [043](043-deterministic-watch-coordinator.md) | delivered (W; PR #58) | P0 | Serialized hash-reconciled project watcher | 039, 040 |
| [044](044-jsdoc-java-watch-vertical-slice.md) | delivered (W; PR #59) | P0 | JS/JSDoc edit → Java → `javac` recovery slice | 043 |
...
- implemented all-text-target checks and deterministic watch/build work publish only complete staged generations, derive compiler behavior from target-owned plans, serialize cycles and child processes, retain last-good outputs on failure, and prove recovery with real filesystem/toolchain tests;

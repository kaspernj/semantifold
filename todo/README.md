...
- [033 — Reference classes, methods, and constructors](033-reference-classes-methods-and-constructors.md) — implemented and proposed in PR #43; coordinator-owned review / CI / merge pending
...
| [033](033-reference-classes-methods-and-constructors.md) | proposed in PR #43 (S) | P1 | Bounded nominal reference classes for the original five; local focused validation green, review / CI / merge pending | 005, 009 |

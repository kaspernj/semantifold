...
- [044 — JavaScript/JSDoc-to-Java watch vertical slice](044-jsdoc-java-watch-vertical-slice.md) — implementation complete on feature branch; local focused/static/package validation passed
...
| [044](044-jsdoc-java-watch-vertical-slice.md) | implementation complete (W; review/CI/merge pending) | P0 | JS/JSDoc edit → Java → `javac` recovery slice | 043 |

...
- [026 — Apple/iOS application artifact target](026-apple-ios-application-target.md) — generation/materialization implemented; Apple acceptance deferred
...
| Apple/iOS | Ruby and any registered project frontend | implemented application generation; Apple acceptance deferred | deterministic unsigned Swift/Xcode project model | Swift 6.3.3 Linux proof; Xcode/iOS Simulator deferred | Task 010 project to UI shell |

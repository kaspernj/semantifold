...
| [`@driftlog/tree-sitter-dart`](https://registry.npmjs.org/%40driftlog%2Ftree-sitter-dart/1.0.4) | `1.0.4` | selected exact registry route for Task 029; ABI 15, Node 24/CST, source/tag identity, signatures, and local build passed; Dart 3.13.3 differential follows the canonical rebuild |

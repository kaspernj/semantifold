...
| [`tree-sitter-dart-orchard`](https://registry.npmjs.org/tree-sitter-dart-orchard/0.7.0) | `0.7.0` | selected by the authorized Task 029 amendment; immutable `v0.7.0`, ABI 14, Node 24/CST, clean install/`npm ci`, signatures, and packed consumer pass; Dart 3.13.3 differential follows the canonical rebuild |

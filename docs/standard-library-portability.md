...
Status: portability architecture; Task 034's single-module effect/lifetime foundation is delivered through PR #44 (merged as `c15e0874c054b6c462304eb29538d72ed43829d6`), and Task 035's versioned canonical contract/provider-linking hub is implemented locally. Neither is released in `semantifold@0.3.0`.

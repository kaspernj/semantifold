...
- Rust accepts only the dependency-free generated Cargo manifest/lock, runs locked offline build/check with isolated Cargo home/target state, and removes that state before publication.

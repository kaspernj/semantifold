...
| AC08 | implemented | Ruby/Dart/Swift mapping, renderer-owned configuration spans, stable semantic program identities/linkage, ownership, and asset provenance are covered. |

...
export {ProjectManifestLoader, SemantifoldProject} from "./src/project-manifest.js"
export {ProjectSnapshot, ProjectSnapshotBuilder} from "./src/project-snapshot.js"
...
export {ProjectWatchCoordinator} from "./src/project-watch.js"
export {ProjectWatchReporter} from "./src/project-watch-reporter.js"
...
export {createStdlibFacadeRegistry, listStdlibFacades, resolveStdlibFacade} from "./src/stdlib-facades.js"
...
export function generateArtifactSet(input) {
  ...
  const {assets, configuration, filename, language, mapDirective, module, resources, role = "text", sourceMapFilename, sources} = input

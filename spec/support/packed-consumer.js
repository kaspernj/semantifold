...
const dartGrammarPath = semantifoldRequire.resolve("@driftlog/tree-sitter-dart")
const dartGrammar = JSON.parse(await readFile(semantifoldRequire.resolve("@driftlog/tree-sitter-dart/package.json"), "utf8"))
